...
//               Expanded(
//                 child: api_list_final!.length == 0
//                     ? const Center(child: CircularProgressIndicator())
//                     : ListView.builder(
//                         itemCount: api_list_final!.length,
//                         itemBuilder: (context, index) {
//                           final y = api_list_final![index].image;
//                           final x = api_list_final![index].symbol;
//                           final z =
//                               api_list_final![index].currentPrice.toString();
//                           final w = api_list_final![index].high24H.toString();
